# https://github.com/lucidrains/rotary-embedding-torch/tree/main/rotary_embedding_torch
...
class RotaryEmbedding(Module):
    def __init__(
        ...
        if exists(custom_freqs) and not is_tensor(custom_freqs):
            if isinstance(custom_freqs, int):
                # Use the passed int as the cache max sequence length
                cache_max_seq_len = custom_freqs
            # Reset custom_freqs to None so the code calculates defaults below
            custom_freqs = None
        ...
        # Now freqs is guaranteed to be a Tensor, so this won't crash
